You will need to clone this repo for this code to work first.  If you have a Bluetooth or USB ELM327 device, you don't need this fork, you can use the standard library.
